function A_drift = exeDriftParkingCtrlParams(V_des, beta_switch,states_init)
% track given trajectory [x,y,V] using iLQR
% states_init = [x0,y0,theta0]
initialization;
%genCostConstraintFunc;
tic
%% Test drift starting traj
dT = 0.1;
% V_des = 11; % m/s 10 %%%%function input 1
% beta_switch = 0.64;%deg2rad(35);  %%%%%%% function input 2
% (9,40) % (11,30)
